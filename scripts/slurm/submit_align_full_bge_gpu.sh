#!/bin/bash
#SBATCH --job-name=align_full_bge
#SBATCH --output=/scratch/pjbd103/sentences_alignment/logs/align_full_bge_%j.out
#SBATCH --error=/scratch/pjbd103/sentences_alignment/logs/align_full_bge_%j.err
...
MODEL_KEY="bge"
MODEL_DIR="${PROJECT_ROOT}/SentAlign_BGE"
...
echo "== BGE Full-Corpus Alignment =="
...
echo
echo "BGE full-corpus job completed."
