#!/bin/bash
#SBATCH --job-name=align_full_labse
#SBATCH --output=/scratch/pjbd103/sentences_alignment/logs/align_full_labse_%j.out
#SBATCH --error=/scratch/pjbd103/sentences_alignment/logs/align_full_labse_%j.err
...
MODEL_KEY="labse"
MODEL_DIR="${PROJECT_ROOT}/SentAlign_laBSE"
...
echo "== LaBSE Full-Corpus Alignment =="
...
echo
echo "LaBSE full-corpus job completed."
